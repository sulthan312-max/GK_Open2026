...
- `src/pages/RegistrationPage.jsx`: alur pendaftaran utama dengan pilihan kategori, form dinamis, ringkasan, upload bukti pembayaran, dan konfirmasi.
- `src/pages/AdminApp.jsx`: dashboard admin terpisah dengan login Supabase Auth, daftar pendaftar, preview bukti bayar, verifikasi status, dan export CSV.
...
3. Buat storage bucket `payment-proofs` dan set `public=false`.
